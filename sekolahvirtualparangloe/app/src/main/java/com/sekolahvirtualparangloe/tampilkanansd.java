...
public class tampilkanansd extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampilkanansd";
    ...
    public tampilkanansd(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
