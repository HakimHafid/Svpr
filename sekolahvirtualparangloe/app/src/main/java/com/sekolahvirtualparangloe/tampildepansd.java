...
public class tampildepansd extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampildepansd";
    ...
    public tampildepansd(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
