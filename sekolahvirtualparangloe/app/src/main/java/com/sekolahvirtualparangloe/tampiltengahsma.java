...
public class tampiltengahsma extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampiltengahsma";
    ...
    public tampiltengahsma(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
