...
public class tampiltengahsd extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampiltengahsd";
    ...
    public tampiltengahsd(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
