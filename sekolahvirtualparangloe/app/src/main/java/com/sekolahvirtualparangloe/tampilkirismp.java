...
public class tampilkirismp extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampilkirismp";
    ...
    public tampilkirismp(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
