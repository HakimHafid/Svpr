...
public class tampilbelakangsma extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampilbelakangsma ";
    ...
    public tampilbelakangsma (VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
