...
public class tampilbelakangsd extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampilbelakangsd";
    ...
    public tampilbelakangsd (VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
