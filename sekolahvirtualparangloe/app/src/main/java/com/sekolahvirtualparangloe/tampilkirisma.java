...
public class tampilkirisma extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampilkirisma";
    ...
    public tampilkirisma(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
