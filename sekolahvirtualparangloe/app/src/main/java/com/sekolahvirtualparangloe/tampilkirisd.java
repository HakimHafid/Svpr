...
public class tampilkirisd extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampilkirisd";
    ...
    public tampilkirisd(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
