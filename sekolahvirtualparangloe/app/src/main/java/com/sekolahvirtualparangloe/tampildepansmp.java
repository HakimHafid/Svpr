...
public class tampildepansmp extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampildepansmp";
    ...
    public tampildepansmp(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
