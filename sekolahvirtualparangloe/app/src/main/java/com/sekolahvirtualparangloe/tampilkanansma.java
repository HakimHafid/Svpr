...
public class tampilkanansma extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampilkanansma";
    ...
    public tampilkanansma(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
