...
public class tampiltengahsmp extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampiltengahsmp";
    ...
    public tampiltengahsmp(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
