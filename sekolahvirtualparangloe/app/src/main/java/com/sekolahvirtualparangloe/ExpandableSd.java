...
public class ExpandableSd extends BaseExpandableListAdapter {
    private Context context;
    private List<String> listDataHeader;
    private HashMap<String,List<String>> listHashMap;

    public ExpandableSd(Context context, List<String> listDataHeader, HashMap<String, List<String>> listHashMap) {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.list_groupsd, null);
        }
    ...
    public View getChildView(int i, int il, boolean b, View view, ViewGroup viewGroup){
        ...
        {
            LayoutInflater inflater = (LayoutInflater) this.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = inflater.inflate(R.layout.list_itemsd, null);
        }
