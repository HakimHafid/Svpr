...
public class tampilbelakangsmp extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampilbelakangsmp ";
    ...
    public tampilbelakangsmp (VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
