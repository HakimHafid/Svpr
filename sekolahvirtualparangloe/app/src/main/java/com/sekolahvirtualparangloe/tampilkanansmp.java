...
public class tampilkanansmp extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampilkanansmp";
    ...
    public tampilkanansmp(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
