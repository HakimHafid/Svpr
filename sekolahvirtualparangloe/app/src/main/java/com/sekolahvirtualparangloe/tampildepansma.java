...
public class tampildepansma extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "tampildepansma";
    ...
    public tampildepansma(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
